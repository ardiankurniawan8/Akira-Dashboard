...
Route::resource('/management/therapist','TherapistController')->middleware('auth');
...
Route::get('/pembayaran','PagesController@getPembayaran')->middleware('auth');
...
Route::get('/laporan/transaksi','PagesController@getLaporanTransaksi')->middleware('auth');
